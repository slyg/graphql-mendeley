...
exports.getGroups = () => request(`https://api.mendeley.com:443/groups`).then(groups => groups.map(groupDataNormalize));
exports.getGroup = (id) => request(`https://api.mendeley.com:443/groups/${id}`).then(groupDataNormalize);
...
exports.getProfile = (id) => request(`https://api.mendeley.com:443/profiles/${id}`).then(profileDataNormalize);
exports.getProfilesFromSearch = (query, limit) => request(`https://api.mendeley.com:443/search/profiles?query=${query}&limit=${limit}`)
